 ...
 * 쿠폰 정보 VO
 * 
 * <p>마이페이지에서 표시할 쿠폰 정보를 담는 클래스입니다.</p>
...
public class CouponVO {
    ...
    /**
     * 결제 일시 문자열 (YYYY-MM-DD HH24:MI 형식)
     */
    ...
    public String getFormattedPayDate() {
        ...
        // YYYY-MM-DD HH24:MI 형식에서 날짜 부분만 추출
        if (payDtmStr.length() >= 10) {
            return payDtmStr.substring(0, 10);
        }
